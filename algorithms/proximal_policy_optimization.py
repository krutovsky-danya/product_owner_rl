...
class PPO_Discrete_Softmax_Guided(nn.Module):
    ...
    def fit(self, states, actions, rewards, dones, infos):
        ...
        old_log_probs = self._get_log_probs(states, actions, available_actions_mask).detach()
        ...
        for epoch in range(self.epoch_n):
            ...
            for i in range(0, returns.shape[0], self.batch_size):
                ...
                b_new_log_probs = self._get_log_probs(b_states, b_actions, b_available_actions_mask)
