...
def make_tutorial_study(agents,
                        order,
                        trajectory_max_len,
                        episode_n,
                        stage,
    ...
    study = LoggingStudy(env, agent, trajectory_max_len, save_rate=save_rate)
...
def main():
    study = make_tutorial_study([], [], trajectory_max_len=100, episode_n=400, stage="tutorial",
                                with_info=True)
    agent = study.agent
